...
const u8 arrayKeysX[ARRAY_SIZE] = {
	...
	38,  0, 38,  0, 38, 22,  0,  0,  0,
	 0, 26,  2, 38,  0, 20, 23,  0,  0,
	 0, 38, 21,  2, 32,  0,  0,  0,  0,	// 10
	38,  0,  6,  0, 33,  0,  0,  0,  0,
	 0, 37,  9, 28, 18, 38,  0,  0,  0,
	27, 32, 38,  0, 24,  0,  0,  0,  0,
	 0, 38,  2,  0,  0,  0,  0,  0,  0,
	17, 12, 35, 32, 23, 10,  0,  0,  0,	// 15
	33, 33,  0, 38,  0,  0,  0,  0,  0,
	14,  0,  8,  5,  8, 38,  7, 38, 38,
...
const u8 arrayObjectsX[ARRAY_SIZE+20] = {
	...
	22, 28, 34, 27, 34, 28, 37,  0,  0,  0,
	 9, 36,  3, 32, 26, 35,  0,  0,  0,  0,	// 10
	 3, 33,  8,  9, 16, 32,  0,  0,  0,  0,
	 0,  3, 37, 25, 29, 24, 33,  0,  0,  0,
	28, 27, 37, 29,  0, 30,  0,  0,  0,  0,
	 2, 36, 37,  3,  0,  0,  0,  0,  0,  0,
	 8, 37,  0, 37, 20, 36,  8, 28,  0,  0,	// 15
	21, 35, 36,  0,  0,  0,  0,  0,  0,  0,
	 2,  8,  3,  0,  0,  0,  0,  0,  0,  0,
	 3, 24, 35, 11, 27,  3, 24,  0,  0,  0,
	16, 35,  0, 14, 22,  0, 32,  0,  0,  0};
...
void SetMapData() {
	...
	switch(currentMap) {
		...
		case 16: {
			...
			SetSpriteParams(3, PLATFORM,	D_down,  58,  y1,	y1, y4);
